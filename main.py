...
# 🔑 सीक्रेट चाबियां जो रेंडर से लोड होंगी
...
async def home():
    ...
    # 🎨 हूबहू Google Gemini इंटरफ़ेस डिज़ाइन - नाम: AgriDairy Expert AI
    html_content = """
    <!DOCTYPE html>
    <html lang="hi">
    <head>
        ...
        <style>
            * { box-sizing: border-box; font-family: 'Google Sans', Arial, sans-serif; margin: 0; padding: 0; }
            ...
            /* 💬 शुद्ध जेमिनी चैट स्टाइल (प्लेन टेक्स्ट, बिना किसी बबल बॉर्डर के) */
            ...
            /* 🚀 जेमिनी राउंडेड इनपुट बार जो स्क्रीन पर तैरती है */
    ...
    <body>
        ...
        <script>
            ...
            // बाकी के जावास्क्रिप्ट फंक्शन्स पूर्ववत रहेंगे
            ...
            async function askAI() {
                ...
                try {
                    ...
                    let aiDiv = document.createElement('div');
                    aiDiv.className = 'message ai-message';
                    aiDiv.innerText = 'एक बार दोबारा सेंड करें भाई।';
                    aiWrapper.appendChild(aiDiv);
                    chatContainer.appendChild(aiWrapper);
                }
